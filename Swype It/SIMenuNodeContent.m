...
//    return [NSString stringWithFormat:@"%@\nTitle: %@\nGrid Node: %@\nMenu Node: %@\n",[super description],[SIGame titleForMenuType:_type],_gridNode,_menuNode];
//}
//
//#pragma mark -
...
//    self = [super init];
//    if (self) {
//        _menuContentPosition = SIMenuNodeContentPositionCenter;
//        [self initSetup:size];
//    }
//    return self;
//}
...
//}
//
//- (void)setUserMessage:(SKNode *)userMessage {
...
//}
//
//- (void)setMenuContentPosition:(SIMenuNodeContentPosition)menuContentPosition {
//    _menuContentPosition = menuContentPosition;
//    [self layoutXY];
//}
//
///**
...
//    }
//    if (_bottomContentNode) {
//        switch (_menuContentPosition) {
//            case SIMenuNodeContentPositionBottom:
//                _bottomContentNode.position         = CGPointMake(0.0f, -1.0f * (_backgroundNode.size.height / 2.0f));
//                break;
//                
//            default:
